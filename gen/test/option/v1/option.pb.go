...
const file_test_option_v1_option_proto_rawDesc = "" +
	...
	"\x04name\x18\x01 \x01(\tR\x04name2\xa8\x04\n" +
	"\x04Test\x12\x91\x01\n" +
	...
	":update-with-input:${! name.or(throw(\"name is required\")) }\x18\x018\x03\x12\xe0\x01\n" +
	"\x11WorkflowWithInput\x12(.test.option.v1.WorkflowWithInputRequest\x1a\x16.google.protobuf.Empty\"\x88\x01\x8a\xc4\x03\x83\x01\x1a\x11\n" +
