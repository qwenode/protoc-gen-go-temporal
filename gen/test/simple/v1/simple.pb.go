...
const file_test_simple_v1_simple_proto_rawDesc = "" +
	...
	"\rmy-task-queue2\xdd\x03\n" +
	"\x05Other\x12\x8c\x01\n" +
	"\rOtherWorkflow\x12&.mycompany.simple.OtherWorkflowRequest\x1a'.mycompany.simple.OtherWorkflowResponse\"*\x8a\xc4\x03\x1e*\x1cother-workflow/${!uuid_v4()}\x92\xc4\x03\x04\"\x02\b\x1e\x12P\n" +
	"\n" +
